...
def send_signup_email(email_address, token, expiry_text):
    ...
    email.send_email_template(email_address, "signup", template_args={"signup_link": signup_link})
...
def send_login_email(user, token, expiry_text):
    ...
    email.send_email_template(user.email, "login", template_args={"user": user, "login_link": login_link})
...
def send_password_changed_email(user):
    ...
    email.send_email_template(user.email, "password_changed", template_args={"user": user})
...
def send_email_changed_notification_email(user):
    ...
    email.send_email_template(user.email, "email_changed_notification", template_args={"user": user})
